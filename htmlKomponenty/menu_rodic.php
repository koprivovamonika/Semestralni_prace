...
<nav id="nav" class="mymenu">
    <div class="menu-cast1">
        <ul>
            <li><a href="/iwww_semestralni_prace/user/rodic.php" class="menu1"><h1 class="line">Domů</h1></a></li>
            <li><a href="/iwww_semestralni_prace/user/klasifikace-r.php" class="menu1"><h1 class="line">Klasifikace</h1>
                </a></li>
